...
CM_CUSTOM_POS[CM_OBJECTS.DYNAMIC]		 = CM_ARGS_DYNAMIC.NUM;
CM_CUSTOM_POS[CM_OBJECTS.FLSSTRIANGLE] = CM_ARGS_TRIANGLE.NUM;
CM_CUSTOM_POS[CM_OBJECTS.FLDSTRIANGLE] = CM_ARGS_TRIANGLE.NUM;
...
CM_CUSTOM_POS[CM_OBJECTS.SPHERE]		 = CM_ARGS_SPHERE.NUM;
CM_CUSTOM_POS[CM_OBJECTS.CAPSULE]		 = CM_ARGS_CAPSULE.NUM;
CM_CUSTOM_POS[CM_OBJECTS.CYLINDER]	 = CM_ARGS_CYLINDER.NUM;
CM_CUSTOM_POS[CM_OBJECTS.AAB]			 = CM_ARGS_AAB.NUM;
CM_CUSTOM_POS[CM_OBJECTS.BOX]			 = CM_ARGS_BOX.NUM;
CM_CUSTOM_POS[CM_OBJECTS.DISK]		 = CM_ARGS_DISK.NUM;
CM_CUSTOM_POS[CM_OBJECTS.TORUS]		 = CM_ARGS_TORUS.NUM;
